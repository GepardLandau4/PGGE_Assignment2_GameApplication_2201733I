...
public class Player_Multiplayer : MonoBehaviour
{
    ...
    public int[] mRoundsPerSecond = new int[3];
    ...
    void Update()
    {
        //added brackets to the if statement it make it more readabl
    ...
    IEnumerator Coroutine_Firing(int id)
    {
        mFiring[id] = true;
        FireBullet();
        yield return new WaitForSeconds(1.0f / mRoundsPerSecond[id]);
        mFiring[id] = false;
